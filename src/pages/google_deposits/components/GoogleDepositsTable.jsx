...
import { fetchMyGoogleDeposits } from "../helpers/fetchMyGoogleDeposits";
import { format } from "date-fns";

const GoogleDepositsTable = ({ setTotalRecords, params, onPageChange }) => {
    ...
    const {
        ...
        queryKey: ["myGoogleDeposits", params],
        queryFn: () => fetchMyGoogleDeposits({ params }),
    });
...
export default GoogleDepositsTable;
