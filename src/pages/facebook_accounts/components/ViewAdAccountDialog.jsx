                            ...
                            <div className="space-y-2 w-full">
                                ...
                                <div className="flex items-center gap-3 mt-4">
                                    ...
                                    {isEditing ? (
                                        ...
                                        >
                                            <SelectTrigger className="h-8 w-[140px] bg-black/20 border-white/10 text-white text-xs focus:ring-white/20 focus:ring-offset-0 rounded-full">
                                                <SelectValue />
                                            </SelectTrigger>
                            ...
                            <div className="space-y-4">
                                ...
                                <Card className={cn(
                                    ...
                                    <CardContent className="p-5 space-y-4">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            <Label className="text-[11px] font-medium text-zinc-500 uppercase tracking-wide">License Number</Label>
                                            <span className="text-zinc-300 font-medium">{data.license_number || "N/A"}</span>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
