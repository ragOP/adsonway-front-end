...
const AdAccountsTable = ({ setTotalRecords, params, onPageChange }) => {
    ...
    const {
        ...
        queryKey: ["allFacebookAccounts", params],
    ...
    const columns = [
        ...
        },
        {
            ...
            label: "Mode",
            render: (value) => (
                <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium capitalize ${value ? "bg-emerald-500/20 text-emerald-400" : "bg-blue-500/20 text-blue-400"
                    }`}>
